...
*This project started as the storage layer for [Memex](https://memex.garden/), a tool to organize your web-research for yourself and collaboratively. The design of this storage layer was done by [Vincent den Boer](https://www.vdenboer.com/) and you can [read about the original thoughts behind it here](https://www.vdenboer.com/blog/storex-modular-storage).*
