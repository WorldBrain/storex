...
export type FindSingleOptions = DBNameOptions & IgnoreCaseOptions & ReverseOptions & SortingOptions & { fields?: string[] }
...
export type OperationBatch = Array<BatchOperation>
export type BatchOperation = CreateObjectBatchOperation | UpdateObjectsBatchOperation | DeleteObjectsBatchOperation
